...
test.describe.serial('@regression POI Management', () => {
  ...
  const formatted = formatCoords(coords, 'Dutch');
...
test('Add POI Group', async ({ page }) => {
  ...
  test('Edit POI Group', async ({ page }) => {
  ...
  test('Delete POI Group with Replacement', async ({ page }) => {
